...
import pelonPeloRicoCandy from './images/pelon-pelo-rico-mini-mexico.png'
import picaFresaCandy from './images/picaFresa.png'
import pulparindoCandy from './images/pulparindo.png'
...
const App = () => {
    ...
    const dragEnd = (e) => {
        ...
        if (squareBeingReplacedId && validMove &&
            (isRowOfThree || isRowOfFour || isColumnOfThree || isAColumnOfFour)) {
    ...
    return (
        <div className="app">
            ...
            <ScoreBoard puntos={scoreDisplay}/>
        </div>
    );
}
